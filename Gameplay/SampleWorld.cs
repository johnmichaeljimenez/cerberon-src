...
public static class SampleWorld
{
    public static World GetSampleWorldData()
    {
        ...
        LightingSystem.AddLight("light", new(-14.5f, 22), Colors.WHITE.Fade(0.8f), 0, 64, shadowType: Light.ShadowTypes.Static);
        LightingSystem.AddLight("light", new(22, 36), Colors.WHITE.Fade(0.8f), 0, 64, shadowType: Light.ShadowTypes.Static);
        LightingSystem.AddLight("light", new(-38, 33), Colors.WHITE.Fade(0.8f), 0, 64, shadowType: Light.ShadowTypes.Static);
